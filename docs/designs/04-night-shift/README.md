...
| `PDP` | `Gallery(96,156,744,900)` + `PurchaseInfo(864,156,456,760)` → `TechnicalDetails(96,1080,1248,420)` → `RelatedProducts(96,1524,1248,510)` | `Gallery(16,86,358,448)` → `PurchaseInfo(16,566,358,650)` → `TechnicalDetails(16,1238,358,420)` → `RelatedProducts(16,1682,358,420)`; purchase bar `0,692,390,72`; narrow `0,648,360,72` |
| `CART_DRAWER`, `CART` | Drawer `1008,0,432,900`; cart page `Items(96,156,816,720)` + `Summary(936,156,408,640)` | Sheet `0,86,390,758`; cart page `Items(16,86,358,620)` → `Summary(16,738,358,360)`; sticky CTA `16,712,358,52`; narrow `16,668,328,52` |
| `AUTH`, `CHECKOUT_ADDRESS`, `CHECKOUT_SHIPPING`, `CHECKOUT_PAYMENT` | Auth `Panel(492,206,456,560)`; checkout `Form(96,156,816,680)` + `Summary(936,156,408,640)` and stepper `96,116,816,32` | Auth `Form(16,86,358,650)`; checkout `Step(16,86,358,620)` → `Summary(16,730,358,300)`; sticky CTA `16,712,358,52`; narrow `16,668,328,52` |
