...
To start the local PostgreSQL and Redis services, wait for both health checks, run Prisma generation/migrations/seed, and launch the Bun API with the matching connection URLs, use the convenience command from the repository root:
