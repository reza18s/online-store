...
- `WEB-002` — 🟡 discovery/cart slices are locally integrated through `36efd32` and `47cb203`, with parent route integration in `465ce07`; the bounded guest-cart conflict recovery follow-up is integrated in `b091396` and `4b0aa61`; focused tests and web typecheck pass, while live/browser/mobile QA remains open.
